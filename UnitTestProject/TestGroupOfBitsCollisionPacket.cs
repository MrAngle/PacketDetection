...
namespace UnitTests
{
    ...
    public class TestGroupOfBitsCollisionPacket
    {
        ...
        public void TestGroupOfBitsCollisionPacket1()
        {
            ...
            BitsCollision BC = new BitsCollision.Builder().SetBasedOnPackage(true, 0).ChangeGroupOfBits(0).Create();
        ...
        public void TestGroupOfBitsCollisionPacket2()
        {
            ...
            BitsCollision BC = new BitsCollision.Builder().SetBasedOnPackage(true, 1).ChangeGroupOfBits(0).Create();
        ...
        public void TestGroupOfBitsCollisionPacket4()
        {
            ...
            BitsCollision BC = new BitsCollision.Builder().SetBasedOnPackage(true, 0).ChangeGroupOfBits(5).Create();
